...
namespace Gamekit3D
{
    public partial class Damageable : MonoBehaviour
    {
        ...
        //melee weapon calls this before ApplyDamage.  If it hits a dead angle, its counted as an invulnerable hit
        public bool CheckAngle(DamageMessage data)
        {
        ...
        public void ApplyDamage(DamageMessage data)
        {
            ...
            if (currentHitPoints <= 0)
                ...
                OnReceiveDamage.Invoke(); //Debug.Log("ondamagerecieve invoked");
            ...
            //Debug.Log("health is " + currentHitPoints);
        }
