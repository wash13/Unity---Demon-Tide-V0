...
namespace Gamekit3D
{
    public class worldControl3 : MonoBehaviour
    {
        public GameObject centerText;
        public spawnControlB3 spawnSystem;
        ...
        void Update()
        {
            ...
            if (player.leveled && !inEnd)
            {
                ...
                GetComponentInChildren<spawnControlB3>().stop();
                Destroy(GetComponentInChildren<spawnControlB3>().gameObject);
            }
        }

        IEnumerator startSequence()
        {
            centerText.GetComponentInChildren<Text>().text = "As your devotion is bolstered, blasphemies take root in the corrupt";
