...
namespace Gamekit3D
{
    public class worldControl2 : MonoBehaviour
    {
        ...
        public spawnControlB2 spawnSystem;
        ...
        void Update()
        {
            ...
            if (player.leveled && !inEnd)
            {
                ...
                GetComponentInChildren<spawnControlB2>().stop();
                Destroy(GetComponentInChildren<spawnControlB2>().gameObject);
            }
        }

        IEnumerator startSequence()
        {
            centerText.GetComponentInChildren<Text>().text = "As your light grows stronger \nthe shadows deepen";
